...
int extract_id(const char* str, const int max_length) {
  ...
  5c:	eb050513          	addi	a0,a0,-336 # f08 <malloc+0xec>
  ...
  7e:	e8eb0b13          	addi	s6,s6,-370 # f08 <malloc+0xec>
  82:	864e                	mv	a2,s3
  84:	85da                	mv	a1,s6
  86:	8526                	mv	a0,s1
...
int extract_origin_priority(const char* str, const int max_length) {
 ...
 122:	dfa50513          	addi	a0,a0,-518 # f18 <malloc+0xfc>
 ...
 144:	dd8b0b13          	addi	s6,s6,-552 # f18 <malloc+0xfc>
 148:	864e                	mv	a2,s3
 14a:	85da                	mv	a1,s6
 14c:	8526                	mv	a0,s1
...
int extract_final_priority(const char* str, const int max_length) {
 ...
 1e8:	d4c50513          	addi	a0,a0,-692 # f30 <malloc+0x114>
 ...
 20a:	d2ab0b13          	addi	s6,s6,-726 # f30 <malloc+0x114>
 20e:	864e                	mv	a2,s3
 210:	85da                	mv	a1,s6
 212:	8526                	mv	a0,s1
...
int check_completion_order(const char* prefix, const char* output, const int* expected_order, int order_length) {
 ...
 2d2:	c7298993          	addi	s3,s3,-910 # f40 <malloc+0x124>
 ...
 332:	fc270713          	addi	a4,a4,-62 # 12f0 <mlfq_info>
...
int test_mlfq_priority_change() {
 ...
 406:	eee48493          	addi	s1,s1,-274 # 12f0 <mlfq_info>
 40a:	00001a97          	auipc	s5,0x1
 40e:	f22a8a93          	addi	s5,s5,-222 # 132c <mlfq_info+0x3c>
 ...
 41a:	bbab8b93          	addi	s7,s7,-1094 # fd0 <malloc+0x1b4>
            case 4:
                if (res.finish_priority >= res.origin_priority) {
 ...
 422:	c72b0b13          	addi	s6,s6,-910 # 1090 <malloc+0x274>
        switch (res.id) {
 426:	4985                	li	s3,1
 ...
 45e:	90a080e7          	jalr	-1782(ra) # d64 <printf>
                break;
 ...
 46e:	8fa080e7          	jalr	-1798(ra) # d64 <printf>
                break;
 472:	bf75                	j	42e <test_mlfq_priority_change+0x42>
                    printf("FAILED: CPU-intensive process %d should have a lower priority than origin priority, but got origin prio %d, finish prio %d\n", res.id, res.origin_priority, res.finish_priority);
 474:	00001517          	auipc	a0,0x1
 478:	adc50513          	addi	a0,a0,-1316 # f50 <malloc+0x134>
 47c:	00001097          	auipc	ra,0x1
 480:	8e8080e7          	jalr	-1816(ra) # d64 <printf>
                    return 0;
 484:	4501                	li	a0,0
 ...
 48e:	b8650513          	addi	a0,a0,-1146 # 1010 <malloc+0x1f4>
 492:	00001097          	auipc	ra,0x1
 496:	8d2080e7          	jalr	-1838(ra) # d64 <printf>
                    return 0;
 49a:	4501                	li	a0,0
...
int main(int argc, char* argv[]) {
 ...
 4de:	bf650513          	addi	a0,a0,-1034 # 10d0 <malloc+0x2b4>
 4e2:	00001097          	auipc	ra,0x1
 4e6:	882080e7          	jalr	-1918(ra) # d64 <printf>
    int score = 0;
 ...
 4f4:	ca050513          	addi	a0,a0,-864 # 1190 <malloc+0x374>
 4f8:	00001097          	auipc	ra,0x1
 4fc:	86c080e7          	jalr	-1940(ra) # d64 <printf>
    int score = 0;
 500:	4481                	li	s1,0
    }
 ...
 508:	cac50513          	addi	a0,a0,-852 # 11b0 <malloc+0x394>
 50c:	00001097          	auipc	ra,0x1
 510:	858080e7          	jalr	-1960(ra) # d64 <printf>
    exit(0);
 514:	4501                	li	a0,0
 ...
 52e:	bc650513          	addi	a0,a0,-1082 # 10f0 <malloc+0x2d4>
 532:	00001097          	auipc	ra,0x1
 536:	832080e7          	jalr	-1998(ra) # d64 <printf>
 ...
 560:	bac50513          	addi	a0,a0,-1108 # 1108 <malloc+0x2ec>
 564:	00001097          	auipc	ra,0x1
 568:	800080e7          	jalr	-2048(ra) # d64 <printf>
        for (int j = 0; j < MAX_PROCESSES; j++) {
 56c:	47d1                	li	a5,20
 56e:	02f987b3          	mul	a5,s3,a5
 572:	00001b17          	auipc	s6,0x1
 576:	d16b0b13          	addi	s6,s6,-746 # 1288 <expected_order>
 ...
 584:	ba0a8a93          	addi	s5,s5,-1120 # 1120 <malloc+0x304>
 588:	00092583          	lw	a1,0(s2)
 58c:	8556                	mv	a0,s5
 58e:	00000097          	auipc	ra,0x0
 592:	7d6080e7          	jalr	2006(ra) # d64 <printf>
        for (int j = 0; j < MAX_PROCESSES; j++) {
 ...
 5a0:	b8c50513          	addi	a0,a0,-1140 # 1128 <malloc+0x30c>
 5a4:	00000097          	auipc	ra,0x0
 5a8:	7c0080e7          	jalr	1984(ra) # d64 <printf>
 ...
 5b4:	cd870713          	addi	a4,a4,-808 # 1288 <expected_order>
 5b8:	973e                	add	a4,a4,a5
 5ba:	098e                	slli	s3,s3,0x3
 5bc:	00001797          	auipc	a5,0x1
 5c0:	d1c78793          	addi	a5,a5,-740 # 12d8 <prefix>
 ...
 5e4:	b5050513          	addi	a0,a0,-1200 # 1130 <malloc+0x314>
 5e8:	00000097          	auipc	ra,0x0
 5ec:	77c080e7          	jalr	1916(ra) # d64 <printf>
                score = 1;
 5f0:	4485                	li	s1,1
 ...
 616:	b4e50513          	addi	a0,a0,-1202 # 1160 <malloc+0x344>
 61a:	00000097          	auipc	ra,0x0
 61e:	74a080e7          	jalr	1866(ra) # d64 <printf>
    int score = 0;
 622:	4481                	li	s1,0
 ...
 62c:	b1850513          	addi	a0,a0,-1256 # 1140 <malloc+0x324>
 630:	00000097          	auipc	ra,0x0
 634:	734080e7          	jalr	1844(ra) # d64 <printf>
                    score = 1;
 638:	b5e9                	j	502 <main+0x44>
            printf("Test%s FAILED\n", program_name);
 63a:	85d2                	mv	a1,s4
 63c:	00001517          	auipc	a0,0x1
 640:	b4450513          	addi	a0,a0,-1212 # 1180 <malloc+0x364>
 644:	00000097          	auipc	ra,0x0
 648:	720080e7          	jalr	1824(ra) # d64 <printf>
...
dup2:
 li a7, SYS_dup2
 a5c:	68b5                	lui	a7,0xd
 a5e:	4318889b          	addiw	a7,a7,1073 # d431 <__global_pointer$+0xb9a9>
 ecall
 a62:	00000073          	ecall
 ret
 a66:	8082                	ret

0000000000000a68 <set_timeslice>:
.global set_timeslice
set_timeslice:
 li a7, SYS_set_timeslice
 a68:	68b5                	lui	a7,0xd
 a6a:	4328889b          	addiw	a7,a7,1074 # d432 <__global_pointer$+0xb9aa>
 ecall
 a6e:	00000073          	ecall
 ret
 a72:	8082                	ret

0000000000000a74 <set_priority>:
.global set_priority
set_priority:
 li a7, SYS_set_priority
 a74:	68b5                	lui	a7,0xd
 a76:	4338889b          	addiw	a7,a7,1075 # d433 <__global_pointer$+0xb9ab>
 ecall
 a7a:	00000073          	ecall
 ret
 a7e:	8082                	ret

0000000000000a80 <get_priority>:
.global get_priority
get_priority:
 li a7, SYS_get_priority
 a80:	68b5                	lui	a7,0xd
 a82:	4348889b          	addiw	a7,a7,1076 # d434 <__global_pointer$+0xb9ac>
 ecall
 a86:	00000073          	ecall
 ret
 a8a:	8082                	ret
...
putc(int fd, char c)
{
 ...
 a94:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 a98:	4605                	li	a2,1
 a9a:	fef40593          	addi	a1,s0,-17
 a9e:	00000097          	auipc	ra,0x0
 aa2:	e8e080e7          	jalr	-370(ra) # 92c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 abc:	84aa                	mv	s1,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 abe:	c299                	beqz	a3,ac4 <printint+0x16>
 ac0:	0805c863          	bltz	a1,b50 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ac4:	2581                	sext.w	a1,a1
  neg = 0;
 ac6:	4881                	li	a7,0
  }

  i = 0;
 ac8:	fc040993          	addi	s3,s0,-64
  neg = 0;
 acc:	86ce                	mv	a3,s3
  i = 0;
 ace:	4701                	li	a4,0
  do{
    buf[i++] = digits[x % base];
 ad0:	2601                	sext.w	a2,a2
 ad2:	00000517          	auipc	a0,0x0
 ad6:	79e50513          	addi	a0,a0,1950 # 1270 <digits>
 ada:	883a                	mv	a6,a4
 adc:	2705                	addiw	a4,a4,1
 ade:	02c5f7bb          	remuw	a5,a1,a2
 ae2:	1782                	slli	a5,a5,0x20
 ae4:	9381                	srli	a5,a5,0x20
 ae6:	97aa                	add	a5,a5,a0
 ae8:	0007c783          	lbu	a5,0(a5)
 aec:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
 af0:	0005879b          	sext.w	a5,a1
 af4:	02c5d5bb          	divuw	a1,a1,a2
 af8:	0685                	addi	a3,a3,1
 afa:	fec7f0e3          	bgeu	a5,a2,ada <printint+0x2c>
  if(neg)
 afe:	00088c63          	beqz	a7,b16 <printint+0x68>
    buf[i++] = '-';
 b02:	fd070793          	addi	a5,a4,-48
 b06:	00878733          	add	a4,a5,s0
 b0a:	02d00793          	li	a5,45
 b0e:	fef70823          	sb	a5,-16(a4)
 b12:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
 b16:	02e05663          	blez	a4,b42 <printint+0x94>
 b1a:	fc040913          	addi	s2,s0,-64
 b1e:	993a                	add	s2,s2,a4
 b20:	19fd                	addi	s3,s3,-1
 b22:	99ba                	add	s3,s3,a4
 b24:	377d                	addiw	a4,a4,-1
 b26:	1702                	slli	a4,a4,0x20
 b28:	9301                	srli	a4,a4,0x20
 b2a:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
 b2e:	fff94583          	lbu	a1,-1(s2)
 b32:	8526                	mv	a0,s1
 b34:	00000097          	auipc	ra,0x0
 b38:	f58080e7          	jalr	-168(ra) # a8c <putc>
  while(--i >= 0)
 b3c:	197d                	addi	s2,s2,-1
 b3e:	ff3918e3          	bne	s2,s3,b2e <printint+0x80>
}
 ...
 b4e:	8082                	ret
    x = -xx;
 b50:	40b005bb          	negw	a1,a1
    neg = 1;
 b54:	4885                	li	a7,1
    x = -xx;
 b56:	bf8d                	j	ac8 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 b74:	0100                	addi	s0,sp,128
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
 b76:	0005c903          	lbu	s2,0(a1)
 b7a:	18090f63          	beqz	s2,d18 <vprintf+0x1c0>
 b7e:	8aaa                	mv	s5,a0
 b80:	8b32                	mv	s6,a2
 b82:	00158493          	addi	s1,a1,1
  state = 0;
 b86:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 b8c:	4c55                	li	s8,21
 b8e:	00000c97          	auipc	s9,0x0
 b92:	68ac8c93          	addi	s9,s9,1674 # 1218 <malloc+0x3fc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 b96:	02800d93          	li	s11,40
  putc(fd, 'x');
 b9a:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 b9c:	00000b97          	auipc	s7,0x0
 ba0:	6d4b8b93          	addi	s7,s7,1748 # 1270 <digits>
 ba4:	a839                	j	bc2 <vprintf+0x6a>
        putc(fd, c);
 ba6:	85ca                	mv	a1,s2
 ba8:	8556                	mv	a0,s5
 baa:	00000097          	auipc	ra,0x0
 bae:	ee2080e7          	jalr	-286(ra) # a8c <putc>
 bb2:	a019                	j	bb8 <vprintf+0x60>
    } else if(state == '%'){
 bb4:	01498d63          	beq	s3,s4,bce <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
 bb8:	0485                	addi	s1,s1,1
 bba:	fff4c903          	lbu	s2,-1(s1)
 bbe:	14090d63          	beqz	s2,d18 <vprintf+0x1c0>
    if(state == 0){
 bc2:	fe0999e3          	bnez	s3,bb4 <vprintf+0x5c>
      if(c == '%'){
 bc6:	ff4910e3          	bne	s2,s4,ba6 <vprintf+0x4e>
        state = '%';
 bca:	89d2                	mv	s3,s4
 bcc:	b7f5                	j	bb8 <vprintf+0x60>
      if(c == 'd'){
 bce:	11490c63          	beq	s2,s4,ce6 <vprintf+0x18e>
 bd2:	f9d9079b          	addiw	a5,s2,-99
 bd6:	0ff7f793          	zext.b	a5,a5
 bda:	10fc6e63          	bltu	s8,a5,cf6 <vprintf+0x19e>
 bde:	f9d9079b          	addiw	a5,s2,-99
 be2:	0ff7f713          	zext.b	a4,a5
 be6:	10ec6863          	bltu	s8,a4,cf6 <vprintf+0x19e>
 bea:	00271793          	slli	a5,a4,0x2
 bee:	97e6                	add	a5,a5,s9
 bf0:	439c                	lw	a5,0(a5)
 bf2:	97e6                	add	a5,a5,s9
 bf4:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
 bf6:	008b0913          	addi	s2,s6,8
 bfa:	4685                	li	a3,1
 bfc:	4629                	li	a2,10
 bfe:	000b2583          	lw	a1,0(s6)
 c02:	8556                	mv	a0,s5
 c04:	00000097          	auipc	ra,0x0
 c08:	eaa080e7          	jalr	-342(ra) # aae <printint>
 c0c:	8b4a                	mv	s6,s2
      } else {
 ...
 c24:	e8e080e7          	jalr	-370(ra) # aae <printint>
 c28:	8b4a                	mv	s6,s2
      state = 0;
 c2a:	4981                	li	s3,0
 ...
 c40:	e72080e7          	jalr	-398(ra) # aae <printint>
 c44:	8b4a                	mv	s6,s2
      state = 0;
 c46:	4981                	li	s3,0
 c48:	bf85                	j	bb8 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 c4a:	008b0793          	addi	a5,s6,8
 c4e:	f8f43423          	sd	a5,-120(s0)
 c52:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
 c56:	03000593          	li	a1,48
 c5a:	8556                	mv	a0,s5
 c5c:	00000097          	auipc	ra,0x0
 c60:	e30080e7          	jalr	-464(ra) # a8c <putc>
  putc(fd, 'x');
 c64:	07800593          	li	a1,120
 c68:	8556                	mv	a0,s5
 c6a:	00000097          	auipc	ra,0x0
 c6e:	e22080e7          	jalr	-478(ra) # a8c <putc>
 c72:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 c74:	03c9d793          	srli	a5,s3,0x3c
 c78:	97de                	add	a5,a5,s7
 c7a:	0007c583          	lbu	a1,0(a5)
 c7e:	8556                	mv	a0,s5
 c80:	00000097          	auipc	ra,0x0
 c84:	e0c080e7          	jalr	-500(ra) # a8c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 c88:	0992                	slli	s3,s3,0x4
 c8a:	397d                	addiw	s2,s2,-1
 c8c:	fe0914e3          	bnez	s2,c74 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
 c90:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 c94:	4981                	li	s3,0
 c96:	b70d                	j	bb8 <vprintf+0x60>
        s = va_arg(ap, char*);
 c98:	008b0913          	addi	s2,s6,8
 c9c:	000b3983          	ld	s3,0(s6)
        if(s == 0)
 ca0:	02098163          	beqz	s3,cc2 <vprintf+0x16a>
        while(*s != 0){
 ca4:	0009c583          	lbu	a1,0(s3)
 ca8:	c5ad                	beqz	a1,d12 <vprintf+0x1ba>
          putc(fd, *s);
 caa:	8556                	mv	a0,s5
 cac:	00000097          	auipc	ra,0x0
 cb0:	de0080e7          	jalr	-544(ra) # a8c <putc>
          s++;
 cb4:	0985                	addi	s3,s3,1
        while(*s != 0){
 cb6:	0009c583          	lbu	a1,0(s3)
 cba:	f9e5                	bnez	a1,caa <vprintf+0x152>
        s = va_arg(ap, char*);
 cbc:	8b4a                	mv	s6,s2
      state = 0;
 cbe:	4981                	li	s3,0
 cc0:	bde5                	j	bb8 <vprintf+0x60>
          s = "(null)";
 cc2:	00000997          	auipc	s3,0x0
 cc6:	54e98993          	addi	s3,s3,1358 # 1210 <malloc+0x3f4>
        while(*s != 0){
 cca:	85ee                	mv	a1,s11
 ccc:	bff9                	j	caa <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
 cce:	008b0913          	addi	s2,s6,8
 cd2:	000b4583          	lbu	a1,0(s6)
 cd6:	8556                	mv	a0,s5
 cd8:	00000097          	auipc	ra,0x0
 cdc:	db4080e7          	jalr	-588(ra) # a8c <putc>
 ce0:	8b4a                	mv	s6,s2
      state = 0;
 ce2:	4981                	li	s3,0
 ce4:	bdd1                	j	bb8 <vprintf+0x60>
        putc(fd, c);
 ce6:	85d2                	mv	a1,s4
 ce8:	8556                	mv	a0,s5
 cea:	00000097          	auipc	ra,0x0
 cee:	da2080e7          	jalr	-606(ra) # a8c <putc>
      state = 0;
 cf2:	4981                	li	s3,0
 cf4:	b5d1                	j	bb8 <vprintf+0x60>
        putc(fd, '%');
 cf6:	85d2                	mv	a1,s4
 cf8:	8556                	mv	a0,s5
 cfa:	00000097          	auipc	ra,0x0
 cfe:	d92080e7          	jalr	-622(ra) # a8c <putc>
        putc(fd, c);
 d02:	85ca                	mv	a1,s2
 d04:	8556                	mv	a0,s5
 d06:	00000097          	auipc	ra,0x0
 d0a:	d86080e7          	jalr	-634(ra) # a8c <putc>
      state = 0;
 d0e:	4981                	li	s3,0
 d10:	b565                	j	bb8 <vprintf+0x60>
        s = va_arg(ap, char*);
 d12:	8b4a                	mv	s6,s2
      state = 0;
 d14:	4981                	li	s3,0
 d16:	b54d                	j	bb8 <vprintf+0x60>
    }
  }
}
 d18:	70e6                	ld	ra,120(sp)
 d1a:	7446                	ld	s0,112(sp)
 d1c:	74a6                	ld	s1,104(sp)
 d1e:	7906                	ld	s2,96(sp)
 d20:	69e6                	ld	s3,88(sp)
 d22:	6a46                	ld	s4,80(sp)
 d24:	6aa6                	ld	s5,72(sp)
 d26:	6b06                	ld	s6,64(sp)
 d28:	7be2                	ld	s7,56(sp)
 d2a:	7c42                	ld	s8,48(sp)
 d2c:	7ca2                	ld	s9,40(sp)
 d2e:	7d02                	ld	s10,32(sp)
 d30:	6de2                	ld	s11,24(sp)
 d32:	6109                	addi	sp,sp,128
 d34:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 d3e:	e010                	sd	a2,0(s0)
 d40:	e414                	sd	a3,8(s0)
 d42:	e818                	sd	a4,16(s0)
 d44:	ec1c                	sd	a5,24(s0)
 d46:	03043023          	sd	a6,32(s0)
 d4a:	03143423          	sd	a7,40(s0)
  va_list ap;
 ...
 d58:	e04080e7          	jalr	-508(ra) # b58 <vprintf>
}
 d5c:	60e2                	ld	ra,24(sp)
 d5e:	6442                	ld	s0,16(sp)
 d60:	6161                	addi	sp,sp,80
 d62:	8082                	ret

0000000000000d64 <printf>:

void
printf(const char *fmt, ...)
{
 d64:	711d                	addi	sp,sp,-96
 ...
 d7a:	03143c23          	sd	a7,56(s0)
  ...
  va_start(ap, fmt);
 d7e:	00840613          	addi	a2,s0,8
 d82:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
 d86:	85aa                	mv	a1,a0
 d88:	4505                	li	a0,1
 d8a:	00000097          	auipc	ra,0x0
 d8e:	dce080e7          	jalr	-562(ra) # b58 <vprintf>
}
...
free(void *ap)
{
 ...
 da8:	59c7b783          	ld	a5,1436(a5) # 1340 <freep>
 ...
 dd0:	00e6ea63          	bltu	a3,a4,de4 <free+0x4a>
{
 ...
 e12:	52f73923          	sd	a5,1330(a4) # 1340 <freep>
}
 e16:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 e30:	02051493          	slli	s1,a0,0x20
 e34:	9081                	srli	s1,s1,0x20
 e36:	04bd                	addi	s1,s1,15
 e38:	8091                	srli	s1,s1,0x4
 e3a:	00148a1b          	addiw	s4,s1,1
 e3e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 e40:	00000517          	auipc	a0,0x0
 e44:	50053503          	ld	a0,1280(a0) # 1340 <freep>
 e48:	c515                	beqz	a0,e74 <malloc+0x58>
 ...
 e4a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 e4c:	4798                	lw	a4,8(a5)
 e4e:	04977163          	bgeu	a4,s1,e90 <malloc+0x74>
 e52:	89d2                	mv	s3,s4
 e54:	000a071b          	sext.w	a4,s4
 e58:	6685                	lui	a3,0x1
 e5a:	00d77363          	bgeu	a4,a3,e60 <malloc+0x44>
 e5e:	6985                	lui	s3,0x1
 e60:	00098b1b          	sext.w	s6,s3
  p = sbrk(nu * sizeof(Header));
 e64:	0049999b          	slliw	s3,s3,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
 e68:	00000917          	auipc	s2,0x0
 e6c:	4d890913          	addi	s2,s2,1240 # 1340 <freep>
  if(p == (char*)-1)
 e70:	5afd                	li	s5,-1
 e72:	a8a5                	j	eea <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 e74:	00000797          	auipc	a5,0x0
 e78:	4cc78793          	addi	a5,a5,1228 # 1340 <freep>
 e7c:	00000717          	auipc	a4,0x0
 e80:	4cc70713          	addi	a4,a4,1228 # 1348 <base>
 e84:	e398                	sd	a4,0(a5)
 e86:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 e88:	0007a823          	sw	zero,16(a5)
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 e8c:	87ba                	mv	a5,a4
 e8e:	b7d1                	j	e52 <malloc+0x36>
      if(p->s.size == nunits)
 e90:	02e48c63          	beq	s1,a4,ec8 <malloc+0xac>
        p->s.size -= nunits;
 e94:	4147073b          	subw	a4,a4,s4
 e98:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ...
 ea2:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 ea4:	0147a423          	sw	s4,8(a5)
      freep = prevp;
 ea8:	00000717          	auipc	a4,0x0
 eac:	48a73c23          	sd	a0,1176(a4) # 1340 <freep>
      return (void*)(p + 1);
 ...
 ec8:	6398                	ld	a4,0(a5)
 eca:	e118                	sd	a4,0(a0)
 ecc:	bff1                	j	ea8 <malloc+0x8c>
  hp->s.size = nu;
 ece:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 ed2:	0541                	addi	a0,a0,16
 ed4:	00000097          	auipc	ra,0x0
 ed8:	ec6080e7          	jalr	-314(ra) # d9a <free>
  return freep;
 edc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 ee0:	d971                	beqz	a0,eb4 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ee2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 ee4:	4798                	lw	a4,8(a5)
 ee6:	fa9775e3          	bgeu	a4,s1,e90 <malloc+0x74>
    if(p == freep)
 eea:	00093703          	ld	a4,0(s2)
 eee:	853e                	mv	a0,a5
 ef0:	fef719e3          	bne	a4,a5,ee2 <malloc+0xc6>
  p = sbrk(nu * sizeof(Header));
 ef4:	854e                	mv	a0,s3
 ef6:	00000097          	auipc	ra,0x0
 efa:	a94080e7          	jalr	-1388(ra) # 98a <sbrk>
  if(p == (char*)-1)
 efe:	fd5518e3          	bne	a0,s5,ece <malloc+0xb2>
        return 0;
 f02:	4501                	li	a0,0
 f04:	bf45                	j	eb4 <malloc+0x98>
